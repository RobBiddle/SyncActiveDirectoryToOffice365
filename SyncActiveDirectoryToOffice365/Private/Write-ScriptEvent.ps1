...
Function Write-ScriptEvent {
    ...
    New-EventLog -LogName Application -Source 'SyncActiveDirectoryToOffice365' -ErrorAction SilentlyContinue
    Write-EventLog -LogName Application -Source 'SyncActiveDirectoryToOffice365' -EntryType $EntryType -EventID $EventID -Message $Message
}
